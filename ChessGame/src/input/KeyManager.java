...
public class KeyManager implements KeyListener {
	...
	public void tick() {
		/*Check if the key on the ESCAPE position was pressed each tick
		 once attribute controls that the click happens only one time (tick executes pretty fast
		 so it needs a control to not allow multiples call*/
